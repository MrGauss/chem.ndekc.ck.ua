...
<html lang="ua">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{SKINDIR}/css/jquery.css?v=3.1" media="screen" />
        <link rel="stylesheet" type="text/css" href="{SKINDIR}/css/style.css?v=3.1" media="screen" />
