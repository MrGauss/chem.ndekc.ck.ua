                        ...
                        dialog["buttons"][bi]["click"] = function()
                        {
                            ...
                            $(this).parent().append
                                    (
                                        ...
                                        + '<div class="create_new"><input type="text" name="template_name" class="input" value="" placeholder="Введіть назву для збереження поточного набору"><button id="template_save" type="button">&nbsp;</button></div>'
