...
INSERT INTO "public"."expert" ("id", "surname", "name", "phname", "visible", "ts", "login", "password", "token", "group_id", "last_ip", "access_id") VALUES (3, 'Шинкаренко', 'Дмитро', 'Юрійович', 1, '2020-06-09 16:49:04.259652', 'shinkarenko', '1174b4363b1661f9b2c480440a97deea', '81b73622e8117e2e22f25d89b6dab8a6', 1, '192.168.2.127', 3);
...
SELECT pg_catalog.setval('"public"."reagent_id_seq"', 276, true);
...
SELECT pg_catalog.setval('"public"."stock_id_seq"', 414, true);
