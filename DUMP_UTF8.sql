...
INSERT INTO "public"."expert" ("id", "surname", "name", "phname", "visible", "ts", "login", "password", "token", "group_id", "last_ip") VALUES (1, 'Пташкін', 'Роман', 'Леонідович', 1, '2019-12-29 23:17:39.53982', 'root', '855cb86bd065112c52899ef9ea7b9918', 'ed63e0241223ecaace5db661c21375ac', 1, '192.168.137.168');
...
INSERT INTO "public"."using" ("hash", "purpose_id", "date", "group_id", "exp_number", "exp_date", "obj_count", "tech_info", "ucomment") VALUES ('77fdeb9ffde2556d4b82fbac0fefc0e4', 1, '2020-03-31', 1, 'тест-01', '2020-03-31', 12, '', 'PTh1NGdEeTdnTCtzdkR1NHpDeTdpUDc3Z0RpNHorTzQ%3D');
