...
INSERT INTO "public"."expert" ("id", "surname", "name", "phname", "visible", "ts", "login", "password", "token", "group_id", "last_ip", "access_id") VALUES (3, 'Шинкаренко', 'Дмитро', 'Юрійович', 1, '2020-06-10 12:08:09.613944', 'shinkarenko', '1174b4363b1661f9b2c480440a97deea', '155141443ffba4dcfd3d8d24542a412c', 1, '192.168.2.127', 3);
...
SELECT pg_catalog.setval('"public"."dispersion_id_seq"', 66, true);
