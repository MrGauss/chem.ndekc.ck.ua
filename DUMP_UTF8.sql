...
INSERT INTO "public"."expert" ("id", "surname", "name", "phname", "visible", "ts", "login", "password", "token", "group_id", "last_ip") VALUES (3, 'Шинкаренко', 'Дмитро', 'Юрійович', 1, '2020-03-24 17:12:38.05303', 'shinkarenko', '953adda3778dcf339f8debe9a72dcc34', '851338d059fb56a83f577e19a67b23da', 1, '192.168.2.127');
...
SELECT pg_catalog.setval('"public"."reagent_id_seq"', 273, true);
...
SELECT pg_catalog.setval('"public"."stock_gr_1_2020_seq"', 79, true);
...
SELECT pg_catalog.setval('"public"."stock_id_seq"', 389, true);
