...
INSERT INTO "public"."expert" ("id", "surname", "name", "phname", "visible", "ts", "login", "password", "token", "group_id", "last_ip", "access_id") VALUES (1, 'Пташкін', 'Роман', 'Леонідович', 1, '2020-07-06 17:50:08.018335', 'root', '855cb86bd065112c52899ef9ea7b9918', '0f6507200bda91fde5a1c0266700958a', 1, '192.168.137.168', 1);
...
INSERT INTO "public"."expert" ("id", "surname", "name", "phname", "visible", "ts", "login", "password", "token", "group_id", "last_ip", "access_id") VALUES (3, 'Шинкаренко', 'Дмитро', 'Юрійович', 1, '2020-07-06 15:47:05.89883', 'shinkarenko', '1174b4363b1661f9b2c480440a97deea', '0180b99e4fa8c20be251355fe8497889', 1, '192.168.2.127', 3);
...
SELECT pg_catalog.setval('"public"."dispersion_id_seq"', 91, true);
