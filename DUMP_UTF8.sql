...
INSERT INTO "public"."expert" ("id", "surname", "name", "phname", "visible", "ts", "login", "password", "token", "group_id", "last_ip") VALUES (3, 'Шинкаренко', 'Дмитро', 'Юрійович', 1, '2020-03-24 17:12:38.05303', 'shinkarenko', '953adda3778dcf339f8debe9a72dcc34', '31e30b099828743e95b7dcb88b0e6ed9', 1, '192.168.2.127');
...
SELECT pg_catalog.setval('"public"."reagent_id_seq"', 215, true);
...
SELECT pg_catalog.setval('"public"."stock_gr_1_2018_seq"', 14, true);
...
SELECT pg_catalog.setval('"public"."stock_id_seq"', 159, true);
