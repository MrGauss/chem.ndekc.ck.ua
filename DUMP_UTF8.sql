...
INSERT INTO "public"."expert" ("id", "surname", "name", "phname", "visible", "ts", "login", "password", "token", "group_id", "last_ip", "access_id") VALUES (2, 'Шкурдода', 'Сергій', 'Вікторович', 1, '2020-06-01 08:31:14.798857', 'shkurdoda', 'd80daf84242523a7c25c1162a314d3d3', 'c81ca9264594fed818045889c46bc269', 1, '192.168.2.118', 3);
INSERT INTO "public"."expert" ("id", "surname", "name", "phname", "visible", "ts", "login", "password", "token", "group_id", "last_ip", "access_id") VALUES (1, 'Пташкін', 'Роман', 'Леонідович', 1, '2020-06-04 10:02:30.135342', 'root', '855cb86bd065112c52899ef9ea7b9918', '88a18afa61a7a0ab5d907f4e6c5e2adb', 1, '192.168.137.168', 1);
...
INSERT INTO "public"."expert" ("id", "surname", "name", "phname", "visible", "ts", "login", "password", "token", "group_id", "last_ip", "access_id") VALUES (3, 'Шинкаренко', 'Дмитро', 'Юрійович', 1, '2020-06-09 12:08:42.625832', 'shinkarenko', '1174b4363b1661f9b2c480440a97deea', '8a57e9c5e1a514c55d3d997ea3f61ccc', 1, '192.168.2.127', 3);
...
SELECT pg_catalog.setval('"public"."dispersion_id_seq"', 37, true);
