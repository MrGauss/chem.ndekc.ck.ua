...
INSERT INTO "public"."expert" ("id", "surname", "name", "phname", "visible", "ts", "login", "password", "token", "group_id", "last_ip") VALUES (3, 'Шинкаренко', 'Дмитро', 'Юрійович', 1, '2020-03-24 17:12:38.05303', 'shinkarenko', '953adda3778dcf339f8debe9a72dcc34', '9078beae38b32c1732e9b8fccb9d5b67', 1, '192.168.2.127');
...
SELECT pg_catalog.setval('"public"."stock_gr_1_2020_seq"', 46, true);
...
SELECT pg_catalog.setval('"public"."stock_id_seq"', 356, true);
